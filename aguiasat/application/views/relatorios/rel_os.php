            ...
            <div class="widget-content">
                <div class="span12 well">
                    ...
                    <form target="_blank" action="<?php echo base_url() ?>index.php/relatorios/osCustom" method="get">
                        ...
                        <div class="span12 well" style="margin-left: 0">
                            <div class="span6">
                                <label for="">Associação:</label>
                                <select name="associacao" id="" class="span12">
                                    <option value="" disabled selected>Selecione uma Associação</option>
                                    <option value="Associação Acontrans">Associação Acontrans</option>
                                    <option value="Associação Acontrans/SP">Associação Acontrans/SP</option>
                                </select>
                        ...
                        <div class="span12" style="margin-left: 0; text-align: center">
                            ...
                            <!--label class="btn btn-primary" name="csv">CSV</label-->
