...
<head>
        <title>ÁGUIASAT OS</title><meta charset="UTF-8" />
    ...
    <body>
                ...
                <div class="control-group">
                    <div class="controls">
                        <div class="main_input_box">
                            <span class="add-on bg_lg"><i class="icon-user"></i></span><input id="email" name="email" type="text" placeholder="Email" style="margin-top: 0px"/>
                        </div>
                    </div>
                </div>
                <div class="control-group">
                    <div class="controls">
                        <div class="main_input_box">
                            <span class="add-on bg_lb"><i class="icon-lock"></i></span><input name="senha" type="password" placeholder="Senha" style="margin-top: 0px"/>
                        </div>
                    </div>
                </div>
        ...
        <div id="notification" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
          <div class="modal-header">
            ...
            <h4 id="myModalLabel">ACONTRANS OS</h4>
          </div>
