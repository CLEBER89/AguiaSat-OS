                        ...
                        <table class="table table-bordered">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <label>
                                            <input name="vPrestadores" class="marcar" type="checkbox" checked="checked" value="1" />
                                    ...
                                    <td>
                                        <label>
                                            <input name="aPrestadores" class="marcar" type="checkbox" value="1" />
                                    ...
                                    <td>
                                        <label>
                                            <input name="ePrestadores" class="marcar" type="checkbox" value="1" />
                                            <span class="lbl"> Editar Prestador</span>
                                        </label>
                                    </td>
                                    <td>
                                        <label>
                                            <input name="dPrestadores" class="marcar" type="checkbox" value="1" />
