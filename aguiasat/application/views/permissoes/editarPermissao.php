                            ...
                            <tbody>
                                ...
                                <tr><td colspan="4"></td></tr>
                                 <tr>
                                    ...
                                    <td>
                                        <label>
                                            <input <?php if (isset($permissoes['vPrestadores'])) {
                                                if ($permissoes['vPrestadores'] == '1') {
                                                    echo 'checked';
                                                }
}?> name="vPrestadores" class="marcar" type="checkbox" value="1" />
                                            <span class="lbl"> Visualizar Prestador</span>
                                        </label>
                                    </td>

                                    <td>
                                        <label>
                                            <input <?php if (isset($permissoes['aPrestadores'])) {
                                                if ($permissoes['aPrestadores'] == '1') {
                                                    echo 'checked';
                                                }
}?> name="aPrestadores" class="marcar" type="checkbox" value="1" />
                                            <span class="lbl"> Adicionar Prestador</span>
                                        </label>
                                    </td>

                                    <td>
                                        <label>
                                            <input <?php if (isset($permissoes['ePrestadores'])) {
                                                if ($permissoes['ePrestadores'] == '1') {
                                                    echo 'checked';
                                                }
}?> name="ePrestadores" class="marcar" type="checkbox" value="1" />
                                            <span class="lbl"> Editar Prestador</span>
                                        </label>
                                    </td>
                                    <td>
                                        <label>
                                            <input <?php if (isset($permissoes['dPrestadores'])) {
                                                if ($permissoes['dPrestadores'] == '1') {
                                                    echo 'checked';
                                                }
}?> name="dPrestadores" class="marcar" type="checkbox" value="1" />
                                            <span class="lbl"> Excluir Prestador</span>
                                        </label>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <label>
                                            <input <?php if (isset($permissoes['cAuditoria'])) {
                                                if ($permissoes['cAuditoria'] == '1') {
                                                    echo 'checked';
                                                }
