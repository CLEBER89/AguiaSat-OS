    ...
    function adicionar()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $permissoes = array(
                  ...
                  'aPrestadores' => $this->input->post('aPrestadores'),
                  'ePrestadores' => $this->input->post('ePrestadores'),
                  'dPrestadores' => $this->input->post('dPrestadores'),
                  'vPrestadores' => $this->input->post('vPrestadores'),
                  ...
                  'rPrestadores' => $this->input->post('rPrestadores'),
